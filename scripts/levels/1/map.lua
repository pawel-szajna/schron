...
world_put(PolygonalSectorBuilder.new(-2,3):withId(2):withCeiling(1):withFloor(0):withWall(0,3,"wall"):withPortal(1,3,"wall",1):withWall(2,3,"wall"):withWall(2,6,"wall"):withWall(1,6,"wall"):withPortal(0,6,"wall",3):withWall(-2,6,"wall"):withWall(-2,3,"wall"))
world_sprite(2, 0, "sprites/lamp", 0.5, 4.5, false)
world_sprite(2, 1, "sprites/lamp", 1.5, 3.5, false)
world_sprite(2, 2, "sprites/metal_table", -0.5, 3.5, true)
world_light(2, 0.5, 4.5, 0.7, 1, 1, 1)
world_light(2, 1.5, 3.5, 0.7, 0.5, 0.3, 0.2)
...
world_sprite(3, 0, "sprites/pipe_with_steam_back", 0.5, 9.5, true)
...
world_sprite(14, 0, "sprites/rocks", 10.5, 8.5, true)
...
world_sprite(16, 0, "sprites/metal_table", 9.5, 4.5, true)
world_sprite(16, 1, "sprites/ola", 9.5, 5.5, true)
